...
describe('Pool', () => {
    ...
    it('should allow burning', async () => {
        ...
        const callWalletAddress = await blockchain.runGetMethod(pool.address, 'get_wallet_address', [
            { type: 'slice', cell: Cell.fromBase64(userAddress.toBoc({ idx: false }).toString('base64')) },
        ])

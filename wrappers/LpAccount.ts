...
export class LpAccount implements Contract {
    ...
    addLiquidity(params: { newAmount0: bigint; newAmount1: bigint; minLPOut: bigint }): Cell {
    ...
    directAddLiquidity(params: { amount0: bigint; amount1: bigint; minLPOut: bigint }): Cell {
